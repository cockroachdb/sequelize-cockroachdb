  ...
  describe('Association options', () => {
    ...
    it('should ignore group from ancestor on deep separated query', async function() {
      ...
      const { count, rows } = await User.findAndCountAll({
        ...
        group: ['userId']
        // group: [['userId']]
        // It was passing and was originally a double nested array, which threw a Deprecation Warning:
        // DeprecationWarning: Passing a double nested nested array to `group` is unsupported and will be removed in v6.
      });
