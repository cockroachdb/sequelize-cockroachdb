...
describe('Instance', () => {
  describe('toJSON', () => {
    ...
    describe('find', () => {
      ...
      // Reason: the test is expecting an "id" as an Int. CockroachDB treats BigInts as Strings.
      // it fails just because the lack of "" at the id field.
      it.skip('returns a response that can be stringified', async function() {
        const user0 = await this.User.create({
          username: 'test.user',
          age: 99,
          isAdmin: true,
      ...
      // Reason: the test is expecting an "id" as an Int. CockroachDB treats BigInts as Strings.
      // it fails just because the lack of "" at the id field.
      it.skip('returns a response that can be stringified and then parsed', async function() {
        const user0 = await this.User.create({
          username: 'test.user',
          age: 99,
          isAdmin: true
